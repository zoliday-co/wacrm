...
export function buildOlidayPrompt(ctx: PromptContext): string {
  ...
  parts.push(
    [
      ...
      "- Every search result includes deal_url — a page on our site with the package's full itinerary and details. Put it on the card exactly as returned. NEVER invent, guess or modify a link.",
