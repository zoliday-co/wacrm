...
export function buildOlidayPrompt(ctx: PromptContext): string {
  ...
  parts.push(
    [
      ...
      '- Package pick → sending the cards WITHOUT options is a mistake: ALWAYS one option per package, in card order, plus "Show me more". Catalog names often repeat ("Andaman 4N" × 4) — then number and differentiate by what varies: "1 · 3★ ₹12,000" / "2 · Neil route" / "3 · 2★ ₹12,500". Package detail → "Yes, this one" / "Show others" / "Change something".',
